...
airline_data = pd.read_csv('airline_data.csv', encoding="ISO-8859-1", dtype={
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
    ...
    if chart == 'OPT1':
        ...
        tree_fig = px.treemap(
            tree_data, path=['DestState', 'Reporting_Airline'], values='Flights', color='Flights', color_continuous_scale='RdBu', title='Flight count by airline to destination state')
